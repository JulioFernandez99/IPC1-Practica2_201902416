...
public class orden_burbuja_descendente extends Thread {
	...
	public orden_burbuja_descendente() {
		
	}

	public orden_burbuja_descendente(String ruta,String Titulo) {
		super();
		this.ruta = ruta;
		this.titulo=Titulo;
	}
	...
	public void run()  {
		...
		try {
	        ...
	        for(int i=3;i<dato.length;i++) {
	        	...
	        	if(i%2==0) {
	        		nums[cn]=Integer.parseInt(dato[i]);
	        		numsdes[cn]=Integer.parseInt(dato[i]);
	        		cn++;
